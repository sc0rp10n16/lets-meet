    ...
    <section className="grid grid-cols-1 gap-10 md:grid-cols-2 xl:grid-cols-3 mb-4 items-center justify-center">
      ...
      {!callDetail ? (
        ...
        >
          <div className="flex flex-col gap-2.5">
            ...
            <Textarea
              className="border-none bg-blue-800 focus-visible:ring-0 focus-visible:ring-offset-0"
              onChange={(e) =>
          ...
          <div className="flex w-full flex-col gap-2.5">
            ...
            <ReactDatePicker
              ...
              className="w-full rounded bg-blue-800 p-2 focus:outline-none"
            />
          </div>
        </MeetModal>
      ) : (
      ...
      >
        <Input
          ...
          className="border-none bg-blue-700 focus-visible:ring-0 focus-visible:ring-offset-0"
        />
      </MeetModal>
